...
var Pagination = {
    ...
    Last: function () {
        Pagination.code += '<i aria-label=" dot dot dot "></i><button role="link" data-text="' + Pagination.size + '"  class="by-keyboard"><span class="show-for-sr">page </span>' + Pagination.size + '</button>';
    },
